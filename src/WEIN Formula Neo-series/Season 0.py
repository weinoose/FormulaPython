...
MCL = Crew('Ron Dennis','Perfect','Good')
SF = Crew('Flavio Briatore','Good','Perfect')
WIL = Crew('Jean Todt','Perfect','Perfect')
LOTUS = Crew('Christian Horner','Good','Perfect')
RB = Crew('Ross Brawn','Perfect','Perfect')
SAUBER = Crew('Toto Wolff','Perfect','Good')
...
sauber = Manufacturer('Benetton Sauber-Ferrari',SAUBER,FERRARI,81.001,86.219,78.928,82.354,84.73,86.785,+0.00,'Balanced',0.148)
lotus = Manufacturer('BWT Team Lotus-Honda',LOTUS,HONDA,77.521,79.09,83.957,89.588,76.99,76.011,-4.83,'Unbalanced',0.138)
mclaren = Manufacturer('Marlboro McLaren-Honda',MCL,HONDA,82.812,81.849,77.016,78.371,78.529,76.484,-2.34,'Balanced',0.15)
redbull = Manufacturer('Gulf Oil Red Bull Racing Ford',RB,FORD,84.58,88.594,80.246,78.133,82.731,87.88,+5.00,'Balanced',0.145)
ferrari = Manufacturer('Scuderia Ferrari Vodafone',SF,FERRARI,74.184,81.845,83.228,78.218,85.936,78.183,+5.92,'Stiff Front',0.132)
williams = Manufacturer('Uralkali Williams Racing',WIL,MERCEDES,76.952,74.381,82.307,75.771,82.104,78.663,-3.29,'Balanced',0.171)
haas = Manufacturer('Sofina Haas-Honda',HAAS,HONDA,78.048,76.366,68.515,70.305,75.178,70.619,+0.00,'Stiff Rear',0.16)
manufacturers = [sauber,lotus,mclaren,redbull,ferrari,williams,haas]
...
MAZ = Driver(williams,'Nikita Mazepin','RUS',None,76,76,72,76,76,76,95,76,76,76,76,[None],None) # 76.853 > 77
LAT = Driver(haas,'Nicholas Latifi','CAN',6,74,74,74,74,74,74,88,74,74,74,74,[None],None) # 75.684 > 76
...
drivers = [VER,LEC,HAM,VET,ALO,PER,NOR,RUS,BOT,STR,RIC,GIO,MAZ,LAT]
