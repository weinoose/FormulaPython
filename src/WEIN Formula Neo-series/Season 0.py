...
bridgestone = Tyre('Bridgestone',2.0,3.3)
michelin = Tyre('Michelin',1.3,2.3)
pirelli = Tyre('Pirelli',-0.1,-0.0)
...
sepang = Circuit('Sepang','Malaysia','Quickness Circuit',56,FIA(current)[0]*78.00,24,[[m,h],[s,s,m],[s,m,s]],2,['Dry','Dry','Dry','Dump','Dump','Wet','Wet','Wet'],'Very Easy') # S:18 | M:26 | H:35
shanghai = Circuit('Shanghai','China','Quickness Circuit',56,FIA(current)[0]*77.75,24,[[m,h],[s,s,m],[s,m,s]],2,['Dry','Dry','Dry','Dry','Dump','Dump','Wet','Wet'],'Very Easy') # S:18 | M:26 | H:35
yeongam = Circuit('Yeongam','South Korea','Quickness Circuit',55,FIA(current)[0]*79.50,28,[[s,h],[s,m],[m,s]],2,['Dry','Dry','Dry','Dry','Dump','Dump','Wet','Wet'],'Easy') # S:20 | M:30 | H:40
india = Circuit('India','India','Quickness Circuit',60,FIA(current)[0]*68.50,20,[[s,s,m],[s,s,h],[s,m,h]],3,['Dry','Dry','Dry','Dry','Dry','Dry','Dump','Wet'],'Easy') # S:16 | M:23 | H:29
# Strength Circuits
...
mexico = Circuit('México City','México','Strength Circuit',71,FIA(current)[0]*62.00,42,[[s,h],[s,m],[m,s]],3,['Dry','Dry','Dry','Dry','Dry','Dry','Dry','Dry'],'Easy') # S:28 | M:43 | H:57
valencia = Circuit('Valencia','Spain','Strength Circuit',57,FIA(current)[0]*80.00,20,[[s,s,m],[s,s,h],[s,m,h]],2,['Dry','Dry','Dry','Dry','Dry','Dump','Dump','Wet'],'Hard')  # S:16 | M:23 | H:29
austin = Circuit('Austin','United States','Strength Circuit',56,FIA(current)[0]*78.50,26,[[m,h],[s,s,m],[s,m,s]],2,['Dry','Dry','Dry','Dry','Dry','Dry','Dry','Dump'],'Very Easy') # S:19 | M:28 | H:37
...
fuji = Circuit('Fuji','Japan','Completeness Circuit',67,FIA(current)[0]*63.50,24,[[s,s,m],[s,s,h],[s,m,m]],1,['Dry','Dry','Dry','Dry','Dump','Dump','Wet','Wet'],'Average') # S:18 | M:26 | H:35
...
yas = Circuit('Yas Island','Abu Dhabi','Completeness Circuit',58,FIA(current)[0]*68.00,20,[[s,s,m],[s,s,h],[s,m,h]],2,['Dry','Dry','Dry','Dry','Dry','Dry','Dry','Dry'],'Average') # S:16 | M:23 | H:29
spielberg = Circuit('Spielberg','Austuria','Completeness Circuit',71,FIA(current)[0]*49.50,18,[[s,h,h],[m,h,h],[m,m,h]],2,['Dry','Dry','Dry','Dry','Dry','Dump','Dump','Wet'],'Very Easy') # S:14 | M:21 | H:27
...
HONDA = Engine('Honda',FIA(current)[5],93,75)
...
FORD = Engine('Ford',FIA(current)[5],76,86)
...
mercedes = Manufacturer('Mercedes-AMG F1 Team',MER,MERCEDES,91,88,82,88,77,91,+0.00,'Balanced',0.17)
williams = Manufacturer('Williams Racing',WIL,MERCEDES,77,77,77,77,84,84,+0.00,'Stiff Rear',0.19)
lotus = Manufacturer('Team Lotus',LOTUS,RENAULT,82,80,77,80,77,80,+0.00,'Unbalanced',0.13)
redbull = Manufacturer('Red Bull Racing',RB,HONDA,88,88,91,98,96,82,+0.00,'Unbalanced',0.20)
renault = Manufacturer('Renault F1 Team',RENAULT,RENAULT,86,82,82,84,84,84,+0.00,'Stiff Front',0.16)
sauber = Manufacturer('Sauber F1 Team',SAUBER,FERRARI,75,77,82,82,75,75,+0.00,'Balanced',0.12)
astonmartin = Manufacturer('Aston Martin F1 Team',AMR,MERCEDES,77,82,77,77,84,84,+0.00,'Unbalanced',0.11)
haas = Manufacturer('Haas F1 Team',HAAS,FERRARI,80,80,80,77,77,77,+0.00,'Balanced',0.15)
manufacturers = [mclaren,ferrari,mercedes,williams,lotus,redbull,renault,sauber,astonmartin,haas]
# Drivers
class Driver():
...
VER = Driver(None,'Max Verstappen','NED',1,90,93,91,94,92,95,95,95,87,86,94,['México City','Zandvoort','Spielberg','Imola','Spa-Francorchamps'],'Unbalanced') # 92.187 > 92
LEC = Driver(None,'Charles Leclerc','MNK',16,93,94,89,95,93,95,88,86,86,90,86,['Monte-Carlo','Spa-Francorchamps','Monza','Sakhir','Spielberg'],'Balanced') # 90.989 > 91
HAM = Driver(None,'Lewis Hamilton','GBR',44,89,89,93,93,91,91,91,92,91,93,92,['Silverstone','Budapest','São Paulo','Montréal','Yas Island'],'Balanced') # 90.97 > 91
VET = Driver(None,'Sebastian Vettel','GER',5,89,90,90,91,88,88,92,94,93,91,93,['Singapore','India','Suzuka','Sepang','Valencia'],'Stiff Rear') # 90.457 > 90
ALO = Driver(None,'Fernando Alonso','ESP',14,87,89,92,91,90,93,86,93,94,94,91,['Budapest','Silverstone','Monza','Barcelona','Valencia'],'Stiff Front') # 90.272 > 90
PER = Driver(None,'Sergio Pérez','MEX',11,87,88,94,90,87,92,85,91,95,92,90,['Baku','Jeddah','Monte-Carlo','Singapore','Sakhir'],'Balanced') # 89.16 > 89
NOR = Driver(None,'Lando Norris','GBR',4,92,91,87,92,86,94,83,87,87,86,87,['Sochi','Spielberg','Monza','Imola'],None) # 88.586 > 89
RUS = Driver(None,'George Russell','GBR',63,91,92,87,92,85,94,90,86,86,87,86,['São Paulo','Budapest','Spa-Francorchamps','Baku'],None) # 88.561 > 89
SAI = Driver(None,'Carlos Sainz Jr.','ESP',55,86,90,85,89,90,90,84,89,88,85,88,['Monte-Carlo','Spielberg','Silverstone'],'Balanced') # 88.122 > 88
BOT = Driver(None,'Valtteri Bottas','FIN',77,89,88,87,89,89,84,80,85,92,89,84,['Sochi','Spielberg','Silverstone','Monza','Montréal'],'Stiff Rear') # 87.192 > 87
OCO = Driver(None,'Esteban Ocon','FRA',31,85,86,86,88,86,91,94,90,90,88,87,['Budapest'],None) # 87.387 > 87
STR = Driver(None,'Lance Stroll','CAN',18,83,83,85,88,86,89,93,88,89,85,89,['Baku'],None) # 86.478 > 86
GAS = Driver(None,'Pierre Gasly','FRA',10,88,87,85,86,85,85,81,84,81,87,85,['Monza'],None) # 85.414 > 85
MAG = Driver(None,'Kevin Magnussen','DEN',20,81,85,85,87,83,86,90,86,85,84,84,['São Paulo'],None) # 84.376 > 84
RIC = Driver(None,'Daniel Ricciardo','AUS',3,79,84,84,84,80,80,89,91,85,87,84,['Monte-Carlo','Baku','Marina Bay','Shanghai','Budapest'],'Stiff Rear') # 83.183 > 83
ALB = Driver(None,'Alex Albon','THI',23,82,82,88,85,84,87,81,82,80,84,81,['Sakhir'],'Stiff Front') # 82.872 > 83
TSU = Driver(None,'Yuki Tsunoda','JPN',22,87,81,81,85,80,84,87,84,83,87,80,['Sakhir'],'Balanced') # 82.866 > 83
PIA = Driver(None,'Oscar Piastri','AUS',None,87,82,82,81,82,86,80,80,80,81,82,[None],None) # 82.488 > 83
MSC = Driver(None,'Mick Schumacher','GER',47,80,80,82,82,79,81,85,88,84,83,83,['Spielberg'],'Balanced') # 81.676 > 82
...
ZHO = Driver(None,'Zhou Guanyu','CHN',24,77,77,79,79,79,79,74,77,77,79,79,[None],None) # 77.959 > # 78
...
LAT = Driver(None,'Nicholas Latifi','CAN',6,74,74,74,74,74,74,88,74,74,74,74,[None],None) # 75.684 > 76
