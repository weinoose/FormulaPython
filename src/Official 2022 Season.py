...
class Tire():
    ...
    def laptime(self,driver,circuit,lap,tire_usage,mode,wxther,situation):
        ...
        if W3 == 'Dry':
            IGNITION = ((((CL0/5)) + (OPENING))) + (circuit.laptime + 42.5)
        elif W3 == 'Dump':
            IGNITION = ((((CL0/5)) + (OPENING))) + (((circuit.laptime)*(25.00))/((90.00))) + (circuit.laptime + 40.5)
        elif  W3 == 'Wet':
            IGNITION = ((((CL0/5)) + (OPENING))) + (((circuit.laptime)*(35.00))/((90.00))) + (circuit.laptime + 40.5)
...
if current in entertainment_era:
    ...
    s = Tire('Soft',FIA(current)[4],1.0,1.0000)
    h = Tire('Hard',FIA(current)[4],2.4,1.0117)
