...
MERCEDES = Engine('Mercedes',FIA(current)[5],92,68)
FERRARI = Engine('Ferrari',FIA(current)[5],90,86)
HONDA = Engine('Honda',FIA(current)[5],81,81)
TOYOTA = Engine('Mercedes',FIA(current)[5],79,92)
RENAULT = Engine('Renault',FIA(current)[5],76,72)
...
mfc1 = Manufacturer('?',T1,MERCEDES,00,00,00,00,00,00,00,+0.00,'Balanced')
mfc2 = Manufacturer('?',T2,HONDA,00,00,00,00,00,00,00,+0.00,'Unbalanced')
mfc3 = Manufacturer('?',T3,FERRARI,00,00,00,00,00,00,00,+0.00,'Stiff Front')
mfc4 = Manufacturer('?',T4,MERCEDES,00,00,00,00,00,00,00,+0.00,'Stiff Rear')
mfc5 = Manufacturer('?',T5,RENAULT,00,00,00,00,00,00,00,+0.00,'Balanced')
mfc6 = Manufacturer('?',T6,HONDA,00,00,00,00,00,00,00,+0.00,'Balanced')
mfc7 = Manufacturer('?',T7,MERCEDES,00,00,00,00,00,00,00,+0.00,'Balanced')
mfc8 = Manufacturer('?',T8,MERCEDES,00,00,00,00,00,00,00,+0.00,'Balanced')
mfc9 = Manufacturer('?',T9,FERRARI,00,00,00,00,00,00,00,+0.00,'Balanced')
mfcx = Manufacturer('?',T10,FERRARI,00,00,00,00,00,00,00,+0.00,'Balanced')
manufacturers = [mfc1,mfc2,mfc3,mfc4,mfc5,mfc6,mfc7,mfc8,mfc9,mfcx]
...
# VER = Driver(redbull,'Max Verstappen','NED',1,90,93,91,95,93,95,95,95,87,86,94,['México City','Zandvoort','Spielberg','Imola','Spa-Francorchamps'],'Unbalanced')
drivers = []
